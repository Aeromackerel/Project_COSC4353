    ...
    public void actionPerformed(ActionEvent e){
        ...
        if (s.equals("Cut")){
            ...
            if (direct != "") {
                ...
                panel.updateList(new File("C:/Users/kterw/OneDrive/Desktop"));
            } 
            else {
            ...
            if (direct != "") {
                ...
                JOptionPane.showMessageDialog(frame, "Cannot save project.  Please close current project");
            } 
        }
            ...
            if (direct != "") {
                ...
                JOptionPane.showMessageDialog(frame, "Cannot open a file. Please start or open a project");
            }
        }
...
class FileTree extends JPanel implements TreeSelectionListener {
    JTree tree;
